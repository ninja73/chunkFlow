...
| `DATABASE_URL` | postgres://chunkflow:chunkflow@postgres:5432/chunkflow?sslmode=disable` |

Ноды можно добавлять строго в конец списка
